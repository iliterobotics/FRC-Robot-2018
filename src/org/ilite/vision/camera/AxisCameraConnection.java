     ...
     public void connect() {
          try {
               ...
               try {
                    ...
                    huc.disconnect();
                    ie.printStackTrace();
                    // connect(); I don't want to reconnect if the thread is interrupted
               }
               connect();
          } catch (Exception e) {
               e.printStackTrace();
...
/**
* This class parses an MJPEG stream, notifying ChangeListeners whenever a valid segment is encountered.
* 
* @author Carl Gould
*/
