...
public class FieldDimensions {
  ...
  public static final double LEFT_SWITCH_FRONT_X = 0;
  public static final double LEFT_SWITCH_FRONT_Y = 0;
  
  public static final double RIGHT_SWITCH_FRONT_X = 0;
  public static final double RIGHT_SWITCH_FRONT_Y = 0;
  
  public static final double LEFT_SWITCH_SIDE_X = 0;
  public static final double LEFT_SWITCH_SIDE_Y = 0;
  
  public static final double RIGHT_SWITCH_SIDE_X = 0;
  public static final double RIGHT_SWITCH_SIDE_Y = 0;
  ...
  public static final double LEFT_SCALE_X = 0;
  public static final double LEFT_SCALE_Y = 0;
  
  public static final double RIGHT_SCALE_X = 0;
  public static final double RIGHT_SCALE_Y = 0;
