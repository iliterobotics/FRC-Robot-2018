...
//		ICameraConnection cameraConnection = CameraConnectionFactory.getCameraConnection("10.18.85.12");
...
//	UPPER_BOUNDS = new Scalar(93,255,240);
	LOWER_BOUNDS = new Scalar(60,150,150),
	UPPER_BOUNDS = new Scalar(70,165,165);
